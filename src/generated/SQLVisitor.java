...
public interface SQLVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SQLParser#jar_pathe}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitJar_pathe(SQLParser.Jar_patheContext ctx);
	/**
	 * Visit a parse tree produced by {@link SQLParser#parames}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitParames(SQLParser.ParamesContext ctx);
	/**
